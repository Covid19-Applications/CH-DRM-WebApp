        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/chand/p1.gif" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">CHANDIGARH ANALYSIS</h3>
        ...
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            ...
            <ul class="list-unstyled footer-link d-flex footer-social">
              <li><a href="#" class="p-2" style="color: tan"><span class="fa fa-twitter"></span></a></li>
              <li><a href="#" class="p-2"style="color: tan"><span class="fa fa-facebook"></span></a></li>
              <li><a href="#" class="p-2"style="color: tan"><span class="fa fa-linkedin"></span></a></li>
              <li><a href="#" class="p-2"style="color: tan"><span class="fa fa-instagram"></span></a></li>
            </ul>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: tan">Address:</span>
                  <span style="color: tan">34 Street Name, Chandigarh, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: tan" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: tan">Email:</span><span>info@echandigarh.com</span></li>
              </ul>
            </div>
          </div>
